...
const EXERCISES: {
  ...
  { name: 'Close-Grip Bench Press', category: 'CHEST', description: 'Barbell bench press with a narrower grip (roughly shoulder-width), shifting emphasis toward the triceps while still engaging the chest and anterior deltoid. Keep elbows closer to the body than a standard bench press to protect the wrists and maximize tricep recruitment.', link: 'https://youtube.com/shorts/xXd7sddHGa0?si=ZeIv2XSPvJc7zgXm' },
  { name: 'Incline Dumbbell Chest Press', category: 'CHEST', description: 'Dumbbell press on a bench set to approximately 30 degrees, with palms facing each other. The incline angle increases upper chest and anterior deltoid involvement; neutral grip reduces shoulder stress compared to a pronated grip.', link: 'https://youtube.com/shorts/8fXfwG4ftaQ?si=cS6QKIOp4koFbEN5' },
  { name: 'Cable Chest Press', category: 'CHEST', description: 'Unilateral or bilateral horizontal press using a cable machine, typically set at chest height. Provides constant tension throughout the range of motion, making it effective for chest hypertrophy with less joint loading than a barbell.', link: 'https://youtube.com/shorts/NXpRKhXg2P8?si=yHf4vP5fDLvhuZnM' },
  { name: 'Scapular Push Up', category: 'CHEST', description: 'Bodyweight movement performed from a push-up or plank position, moving only through the shoulder blades — elbows stay locked while the scapula protracts and retracts. Isolates the serratus anterior and lower trapezius; commonly used as a warm-up or corrective drill to build scapular control and shoulder stability, especially useful for overhead athletes or as injury-prevention work.', link: 'https://youtube.com/shorts/emB58J1SyXA?si=zyAWd_B5KcA4gcrA' },
  { name: 'Dips', category: 'CHEST', description: 'Bodyweight or weighted dip performed on parallel bars, lowering the body until the upper arms are roughly parallel to the floor before pressing back up. Leaning the torso forward shifts emphasis toward the chest and front deltoids; staying upright targets the triceps more directly.', link: 'https://youtube.com/shorts/SXBksC78v8M?si=TEwSt5kZ8mC5s8As' },
  { name: 'Push-Up', category: 'CHEST', description: 'Standard bodyweight push-up from a plank position, hands roughly shoulder-width. Lower the chest toward the floor keeping the body in a straight line, then press back up. Core and glutes braced throughout to prevent the hips sagging or piking — the standard test-format pressing movement.', link: 'https://youtube.com/shorts/4Bc1tPaYkOo?si=SfIznkS_EBSC0ibW' },
  ...
  { name: 'Pull-Up', category: 'BACK', description: 'Bodyweight or weighted pull-up performed with an overhand (pronated) grip, the standard competition/test-format vertical pull. Pull until the chin clears the bar; add weight via a dip belt once bodyweight reps are no longer challenging. More back/lat-dominant and less bicep-driven than the underhand Chin-Up.' },
  ...
  // LEGS
  { name: 'Barbell Squat', category: 'LEGS', description: 'Hip-width barbell back squat, the cornerstone lower-body strength movement targeting quads, glutes, and adductors. Brace the core, sit into the hips, and drive the knees out over the toes; depth should reach at least parallel.', link: 'https://youtube.com/shorts/PPmvh7gBTi0?si=Kl_KQUTKh-SnfeQt' },
  ...
  { name: 'Cable Hip Abduction', category: 'LEGS', description: 'Standing hip abduction using a low cable attachment, isolating the glutes (primarily gluteus medius) and hip abductors. Keep the torso upright and control the return to avoid compensating with the lower back.', link: 'https://youtu.be/wDvzvj6AeL4?si=3koi97rtCsfLpOrL' },
  ...
  { name: 'SA Overhead Lunge', category: 'SHOULDERS', description: 'Walking or stationary lunge performed while holding a single dumbbell or kettlebell locked out overhead in one hand. The lunge is the base; the overhead arm must stay stable and vertical against the offset load throughout. Trains shoulder/scapular stability under unilateral load — valuable for correcting side-to-side overhead stability imbalances.' },
  { name: 'Banded External Rotation', category: 'SHOULDERS', description: 'Standing or half-kneeling external rotation of the shoulder against a light resistance band anchored at elbow height, elbow pinned to the side at 90°. Classic rotator-cuff prehab/rehab movement for shoulder stability and injury prevention; light band tension and full control matter more than resistance.' },
  ...
  { name: 'Landmine Rotation', category: 'CORE', description: 'Standing rotational core exercise using a barbell anchored in a landmine attachment (or corner), gripping the free end with both hands and rotating the torso to sweep the bar from hip to hip. Trains rotational core power and anti-rotation control through a full range of motion — the loaded, dynamic counterpart to the Pallof Press\'s static anti-rotation hold.' },
  ...
  { name: 'Cable Crunch', category: 'CORE', description: 'Kneeling cable crunch flexing the spine against resistance from a high pulley, isolating the rectus abdominis through a full range of motion. Curl through the spine rather than just bending at the hips to keep tension on the abs.', link: 'https://youtu.be/dkGwcfo9zto?si=ijMSt0ANPnjCluQ2' },
